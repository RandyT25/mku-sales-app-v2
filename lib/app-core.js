...
function isNestleRep(name) {
  if (typeof currentRep !== 'undefined' && currentRep && name === currentRep.name && currentRep.dbName) {
    if (NESTLE_REPS.includes(currentRep.dbName)) return true;
  }
  return NESTLE_REPS.includes(name);
}
